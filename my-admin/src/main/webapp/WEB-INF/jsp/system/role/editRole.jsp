	...
	<input type="hidden" name="id" value="${role.id}"/>
	  <div class="layui-form-item">
			      ...
			      <div class="layui-input-inline">
			        <input type="text" name="name" lay-verify="required" placeholder="请输入角色名" value="${role.name}" autocomplete="off" class="layui-input">
			      </div>
			    </div>
			    ...
			    <div class="layui-form-item">
			      ...
			      <div style="width:60%" class="layui-input-inline">
			        <input type="text" name="remark"  placeholder="请输入备注" value="${role.remark}" autocomplete="off" class="layui-input">
			      </div>
			  </div>
			  <div class="layui-form-item">
